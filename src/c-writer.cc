...
std::string CWriter::DefineImportName(const std::string& name,
  ...
  mangled = module_prefix_ + mangled;
...
void CWriter::WriteInitDecl() {
  Write("extern void " + module_prefix_ + "_init_module(void);", Newline());
  Write("extern void " + module_prefix_ + "_init(", ModuleInstanceTypeName(),
        "*");
...
void CWriter::WriteFreeDecl() {
  Write("extern void " + module_prefix_ + "_free(", ModuleInstanceTypeName(),
        "*);", Newline());
}
...
void CWriter::WriteTableExportDecl(const std::string& mangled_name) {
  Write("wasm_rt_table_t* ", mangled_name, "(", ModuleInstanceTypeName(),
        "* module_instance)");
}
...
void CWriter::WriteInit() {
  ...
  Write(Newline(), "void " + module_prefix_ + "_init(",
