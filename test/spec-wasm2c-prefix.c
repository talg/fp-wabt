 ...
 */
static void Z_spectestZ_print(Z_spectest_module_instance_t* module_instance) {
  printf("spectest.print()\n");
}

static void Z_spectestZ_print_i32(Z_spectest_module_instance_t* module_instance,
                                  uint32_t i) {
  printf("spectest.print_i32(%d)\n", i);
}

static void Z_spectestZ_print_f32(Z_spectest_module_instance_t* module_instance,
                                  float f) {
  printf("spectest.print_f32(%g)\n", f);
}

static void Z_spectestZ_print_i32_f32(
...
static void Z_spectestZ_print_f64(Z_spectest_module_instance_t* module_instance,
                                  double d) {
  printf("spectest.print_f64(%g)\n", d);
}

static void Z_spectestZ_print_f64_f64(
    Z_spectest_module_instance_t* module_instance,
    double d1,
    double d2) {
