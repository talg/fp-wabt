...
wasm_rt_externref_t externref(u64 x) {
  return (wasm_rt_externref_t)x;
}

wasm_rt_funcref_t funcref(u64 x) {
  if (x == 0) {
 ...
 */
void Z_spectestZ_print(Z_spectest_module_instance_t* module_instance) {
  printf("spectest.print()\n");
}

void Z_spectestZ_print_i32(Z_spectest_module_instance_t* module_instance,
                           uint32_t i) {
  printf("spectest.print_i32(%d)\n", i);
}

void Z_spectestZ_print_f32(Z_spectest_module_instance_t* module_instance,
                           float f) {
  printf("spectest.print_f32(%g)\n", f);
}

void Z_spectestZ_print_i32_f32(Z_spectest_module_instance_t* module_instance,
                               uint32_t i,
                               float f) {
  printf("spectest.print_i32_f32(%d %g)\n", i, f);
}

void Z_spectestZ_print_f64(Z_spectest_module_instance_t* module_instance,
                           double d) {
  printf("spectest.print_f64(%g)\n", d);
}

void Z_spectestZ_print_f64_f64(Z_spectest_module_instance_t* module_instance,
                               double d1,
                               double d2) {
  printf("spectest.print_f64_f64(%g %g)\n", d1, d2);
}

wasm_rt_funcref_table_t* Z_spectestZ_table(
...
uint32_t* Z_spectestZ_global_i32(
    Z_spectest_module_instance_t* module_instance) {
  return &module_instance->spectest_global_i32;
}

uint64_t* Z_spectestZ_global_i64(
    Z_spectest_module_instance_t* module_instance) {
  return &module_instance->spectest_global_i64;
}

float* Z_spectestZ_global_f32(Z_spectest_module_instance_t* module_instance) {
  return &module_instance->spectest_global_f32;
}

double* Z_spectestZ_global_f64(Z_spectest_module_instance_t* module_instance) {
...
static void init_spectest_module(
  ...
  wasm_rt_allocate_funcref_table(&module_instance->spectest_table, 10, 20);
}
