...
int main(int argc, char** argv) {
  ...
  Z_fac_instantiate(&module_instance);
...
void Z_fac_instantiate(Z_fac_module_instance_t*);
void Z_fac_free(Z_fac_module_instance_t*);

/* export: 'fac' */
u32 Z_facZ_fac(Z_fac_module_instance_t*, u32);
...
`Z_fac_instantiate(Z_fac_module_instance_t*)` creates an instance of
...
u32 Z_hostZ_fill_buf(struct Z_host_module_instance_t* instance,
                     u32 ptr,
                     u32 size) {
  return fill_buf(instance, ptr, size);
}

void Z_hostZ_buf_done(struct Z_host_module_instance_t* instance,
                      u32 ptr,
                      u32 size) {
